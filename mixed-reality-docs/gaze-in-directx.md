...
ms.locfileid: "65629618"
---
# <a name="head-and-eye-gaze-in-directx"></a>Mirada principal y de ojo de DirectX

En Windows Mixed Reality, entrada de mirada se utiliza para determinar lo que está mirando el usuario. Esto se puede usar para los modelos de entrada principales como [que mirar y confirmar](gaze-and-commit.md)y también para proporcionar contexto para los tipos de interacciones. Hay dos tipos de mirada vectores disponibles a través de la API: head mirada y mirada ojos.  Ambos se proporcionan como una de las tres dimensiones ray con un origen y la dirección. Las aplicaciones pueden raycast, a continuación, en su segundo plano o en el mundo real y determine lo que tiene como destino el usuario.
