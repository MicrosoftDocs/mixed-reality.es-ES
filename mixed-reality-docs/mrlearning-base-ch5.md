...
En el componente de controlador de entrada de voz (Script), haga clic en el botón Small **+** para agregar un elemento de palabra clave a la lista de palabras clave:

![mrlearning-base](images/mrlearning-base/tutorial5-section1-step5-1.png)

Haga clic en el **elemento 0** recién creado para expandirlo y, a continuación, en la lista desplegable **palabra clave** , elija la palabra clave **Play Music** que creó anteriormente:
...
En la ventana jerarquía, **cree cuatro cubos** como objetos secundarios del objeto **PanGesture** y establezca su **escala** de transformación en X = 0,15, y = 0,15, Z = 0,15:
...
En la ventana jerarquía, seleccione el objeto **queso** y, a continuación, cree un nuevo en el evento **seleccionado ()** , configure el objeto **queso** para recibir el evento y defina **EyeTrackingTutorialDemo. BlipTarget** como la acción que se va a desencadenar:
