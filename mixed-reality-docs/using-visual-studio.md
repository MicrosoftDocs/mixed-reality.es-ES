...
2. Cree un nuevo proyecto de aplicación universal de Windows en Visual Studio 2015 Update 1, Visual Studio 2017 o Visual Studio 2019. C#se C++admiten todos los proyectos de JavaScript, y. (O siga las instrucciones para [crear una aplicación en Unity](holograms-100.md)).
...
3. Mira el icono de **configuración** y realiza el gesto [de puntear](gestures.md#air-tap) en el aire. Realiza un segundo toque en el aire para colocar la aplicación en tu entorno. La aplicación Configuración se iniciará una vez la hayas colocado.
...
1. Seleccionar una configuración de compilación **x86** para la ![configuración de compilación de la aplicación x86 en Visual Studio](images/x86setting.png)
2. Seleccionar **equipo remoto** en el menú ![desplegable destino de implementación destino de implementación de equipo remoto en Visual Studio](images/remotemachinesetting.png)
3. Para C++ los proyectos de y JavaScript, vaya a **Project > propiedades > propiedades de configuración >** depuración. En C# el caso de los proyectos, aparecerá un cuadro de diálogo automáticamente para configurar la conexión.
  ...
  b. Cuadro de diálogo establecer el modo de autenticación en **universal (protocolo sin cifrar)** ![conexión remota en Visual Studio](images/remotedeploy.png)
...
1. Seleccionar una configuración de compilación **x86** para la ![configuración de compilación de la aplicación x86 en Visual Studio](images/x86setting.png)
2. Seleccionar **dispositivo** en el menú![desplegable de destino de implementación implementación de dispositivos en Visual Studio](images/buildsettingsusbdeploy.png)
...
## <a name="pairing-your-device---hololens-1st-gen"></a>Emparejamiento de su dispositivo: HoloLens (1ª generación)
...
3. Seleccione **emulador de HoloLens** en el destino del emulador![del menú desplegable de destino de implementación en Visual Studio](images/deployemulator.png)
4. Seleccione depurar **> iniciar** depuración para implementar la aplicación e![iniciar la depuración iniciar sin depurar en Visual Studio](images/deploynodebugging.png)
