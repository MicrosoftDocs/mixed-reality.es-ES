...
Este SpatialPointerPose tiene la información necesaria para colocar el holograma según la [título actual del usuario](gaze,-gestures,-and-motion-controllers-in-directx.md).
